(() => {
  ...
  const translations = {
    en: {
      ...
      "side.radiotelescope.text": "Frontend and backend control panel for the <a class=\"project-source-link\" href=\"https://simle.pl/seesky\" target=\"_blank\" rel=\"noopener\">SimLE student research club's 3 m radio telescope</a> - remote control, tracking and monitoring in a single interface.",
      "side.radiotelescope.demonote": "Demo only - no live star or sensor data",
      "side.yapper.text": "Windows desktop app for speech-to-text transcription with two push-to-talk channels and switchable offline/online transcription engines.",
      ...
      "bio.item4": "Math tutoring - <a class=\"identity-link\" href=\"https://www.e-korepetycje.net/xcape/matematyka\" target=\"_blank\" rel=\"me noopener\">from primary school up to advanced high-school level</a>",
    ...
    pl: {
      ...
      "side.radiotelescope.text": "Panel sterowania (frontend i backend) do <a class=\"project-source-link\" href=\"https://simle.pl/seesky\" target=\"_blank\" rel=\"noopener\">radioteleskopu o średnicy 3 m, budowanego w kole naukowym SimLE</a> - zdalne sterowanie, śledzenie i monitorowanie w jednym interfejsie.",
      "side.radiotelescope.demonote": "Wersja demo - bez danych na żywo o gwiazdach ani z czujników",
      "side.yapper.text": "Aplikacja desktopowa na Windows do transkrypcji mowy na tekst, z dwoma kanałami push-to-talk oraz przełączanymi silnikami transkrypcji offline i online.",
      ...
      "bio.item4": "Korepetycje z matematyki - <a class=\"identity-link\" href=\"https://www.e-korepetycje.net/xcape/matematyka\" target=\"_blank\" rel=\"me noopener\">od szkoły podstawowej po poziom rozszerzony w liceum</a>",
