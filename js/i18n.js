(() => {
  ...
  const translations = {
    en: {
      ...
      "activity.uptodate": "Software engineering never stands still, and the tools behind it move even faster - skip that curve and you fall behind. Staying current is what keeps me fast, across coding, data parsing, everything.",
    ...
    pl: {
      ...
      "activity.uptodate": "Inżynieria oprogramowania nigdy nie stoi w miejscu, a narzędzia, które ją napędzają, zmieniają się jeszcze szybciej - kto nie nadąża, zostaje w tyle. Bycie na bieżąco to to, co pozwala mi działać szybko - w kodowaniu, przetwarzaniu danych, we wszystkim.",
