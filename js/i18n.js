(() => {
  ...
  const translations = {
    ...
    pl: {
      ...
      "activity.uptodate": "Inżynieria oprogramowania nigdy nie stoi w miejscu, a narzędzia, które ją napędzają, zmieniają się jeszcze szybciej - kto nie nadąża, zostaje w tyle. Bycie na bieżąco czyni mnie bardziej produktywnym, a nie mniej czujnym: te narzędzia nie są idealne, więc weryfikuję ich wyniki, patrzę na nie okiem eksperta i debuguję to, co wymaga poprawki.",
