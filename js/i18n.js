(() => {
  ...
  const translations = {
    en: {
      ...
      "side.yaper.text": "Windows desktop app for speech-to-text transcription with two push-to-talk channels and switchable offline/online transcription engines.",
      "side.pushtotalk": "Push-to-talk",
      "side.offlineonline": "Offline/Online",
      "activity.kicker": "Find Me Online",
      "activity.title": "My Activity",
      "activity.usage": "Coding Activity",
      "activity.uptodate": "Software engineering never stands still, and the tools behind it move even faster - skip that curve and you fall behind. Staying current makes me more productive, not less careful: these tools aren't perfect, and in sensitive systems - sensor data, bulletproof backends, anything where a bug or security hole could mean real financial or safety consequences - they need to be used carefully and methodically.",
      "activity.summary": "Shipping something most days - features, data pipelines and internal tools, with Claude Code and Codex.",
      ...
      "bio.kicker": "About Me",
      "bio.title": "About Me",
      "bio.intro": "My name is Piotr. I study Electronics and Telecommunications at Gdańsk University of Technology (WETI), currently in my 6th semester on the Computer Electronic Systems profile. What sets me apart is structural thinking - I break every problem down like a tree: category, subcategory, and the connections between them. I learn new things the same way, sorting information into clear categories instead of letting it pile up as chaos. Automation and chaining tools into systems aren't a separate skill - they're just what that mindset looks like in practice, the thread that ties everything else together.",
    ...
    pl: {
      ...
      "side.frontend": "Frontend",
      "side.backend": "Backend",
      "side.yaper.text": "Aplikacja desktopowa na Windows do transkrypcji mowy na tekst, z dwoma kanałami push-to-talk oraz przełączanymi silnikami transkrypcji offline i online.",
      "side.pushtotalk": "Push-to-talk",
      "side.offlineonline": "Offline/Online",
      "activity.kicker": "Aktywność",
      "activity.title": "Nad czym teraz pracuję",
      "activity.usage": "Aktywność w kodowaniu",
      "activity.uptodate": "Inżynieria oprogramowania nigdy nie stoi w miejscu, a narzędzia, które ją napędzają, zmieniają się jeszcze szybciej - kto nie nadąża, zostaje w tyle. Bycie na bieżąco czyni mnie bardziej produktywnym, a nie mniej ostrożnym: te narzędzia nie są idealne, a w czułych systemach - przetwarzaniu danych sensorycznych, kuloodpornych backendach, wszędzie tam, gdzie błąd lub dziura w zabezpieczeniach może oznaczać realne straty finansowe albo zagrożenie zdrowia czy życia - trzeba ich używać uważnie i metodycznie.",
      "activity.summary": "Prawie codziennie coś dowożę - funkcje, pipeline'y danych i narzędzia, z Claude Code i Codexem.",
