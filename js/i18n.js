(() => {
  ...
  const translations = {
    en: {
      ...
      "side.portfolio.title": "This Portfolio",
      "side.portfolio.text": "The site you are looking at - a customized HTML template with custom canvas parallax effects, oscilloscopes and a D3 force-graph hero.",
    ...
    pl: {
      ...
      "side.portfolio.title": "Ta strona",
      "side.portfolio.text": "Portfolio, które właśnie oglądasz. Powstało na bazie szablonu HTML, który rozbudowałem o własne efekty rysowane na canvasie, oscyloskopy i animację grafu D3.",
