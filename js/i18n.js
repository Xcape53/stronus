(() => {
  ...
  const translations = {
    en: {
      ...
      "activity.summary": "Shipping something most days - features, data pipelines and internal tools, with Claude Code and Codex. <span class=\"cc-summary_detail\">772M+ tokens processed &middot; currently on Fable 5</span>",
      "activity.alsowith": "Also using:",
    ...
    pl: {
      ...
      "activity.summary": "Prawie codziennie coś dowożę - funkcje, pipeline'y danych i narzędzia, z Claude Code i Codexem. <span class=\"cc-summary_detail\">Ponad 772 mln przetworzonych tokenów &middot; obecnie Fable 5</span>",
      "activity.alsowith": "Korzystam też z:",
